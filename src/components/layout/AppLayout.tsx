...
const menuItems: MenuItemDef[] = [
  ...
  { key: '/ess', label: '직�l 셀프 서비스(ESS)', icon: <CustomerServiceOutlined />, path: '/ess' },
  { key: '/analytics/ai-dashboard', label: 'AI �{�석 대시보닜', icon: <RobotOutlined />, path: '/analytics/ai-dashboard' },
  ...
  { key: '/billing', label: 'ꪰ제 및 청구 관리', icon: <CreditCardOutlined />, path: '/billing' },
  { key: '/my-page', label: '나의페이지', icon: <UserOutlined />, path: '/my-page' },
];
