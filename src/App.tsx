...
import MultiTenantSettingsPage from '@/pages/멀티테나트설정Page';
import PermissionsPage from '@/pages/권한관리Page';
import AttendancePage from '@/pages/근턜관리Page';
import PayrollManagementPage from '@/pages/금여정찴관리Page';
import PerformancePage from '@/pages/성과뾸 평洱관리Page';
import ESSPage from '@/pages/직원셀프서비스포털ESSPage';
import AIAnalyticsPage from '@/pages/AI분석대시보드Page';
import OpenAPIPage from '@/pages/오폐API관리Page';
import SubscriptionPage from '@/pages/구독관리Page';
import BillingPage from '@/pages/결,��및 청굠 관리Page';
